...
void QVTKFramebufferObjectRenderer::initScene() {
  ...
  this->resetCamera();
  qDebug() << "QVTKFramebufferObjectRenderer::initScene() end";
}
...
void QVTKFramebufferObjectRenderer::updatePlatform() {
  ...
  qDebug() << "QVTKFramebufferObjectRenderer::updatePlatoform() end";
}
...
void QVTKFramebufferObjectRenderer::resetCamera() {
  ...
  qDebug() << "QVTKFramebufferObjectRenderer::resetCamera()";
